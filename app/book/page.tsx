        ...
        <section className='mt-28'>
            <div className='max-w-screen-lg mx-auto'>
                <div className='p-2'>
                    ...
                    <p className='text-center mb-2 text-gray-800 dark:text-white font-semibold'>Ecomás Consultoría y Capacitación</p>
                ...
                <form ref={refForm} onSubmit={handleSubmit(onSubmit)} className='grid grid-cols-1 md:grid-cols-2 gap-4 p-2'>
                    <div className='text-gray-500 md:mt-4'>
                        <label
                            className='font-bold absolute text-lg duration-500 scale-75 origin-[0] dark:text-white'>
                            Apellido paterno:
                        </label>
                    ...
                    <div className='md:col-span-2'>
                        ...
                        <div className='grid grid-cols-2 gap-4 mt-8 mb-6 p-3'>
                            <div className="flex items-center me-4">
                                ...
                                />
                                <label htmlFor="purple-checkbox-reclamo" className="ms-2 font-bold text-gray-600  dark:text-white">Reclamo</label>
                            </div>
                            <div className="flex items-center me-4">
                                <input
                                    ...
                                    className="w-6 h-6 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                />
                                <label htmlFor="purple-checkbox-sugerencia" className="ms-2 font-bold text-gray-600 dark:text-white">Sugerencia</label>
                            </div>
                        </div>
          ...
          <div className='relative'>
            <textarea id="message" rows={10} className="block mt-12 p-2.5 w-full text-gray-900 bg-gray-100 rounded-lg border-2 border-gray-300"
              placeholder="Mensaje">
                        ...
                        <label className='font-bold absolute text-gray-600 text-lg duration-500 scale-75 origin-[0] dark:text-white'>
                            Mensaje:
                        </label>
                        <div className='relative'>
                            <textarea
