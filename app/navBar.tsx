        ...
        <NavbarContent justify="center">
          <NavbarItem>
            <Link href="/certs" passHref legacyBehavior>
              <Button className='bg-gradient-to-r from-[#02227b] to-[#0060ff] text-white'  >
                Ver Certificados
              </Button>
            </Link>
      ...
      <Navbar
        ...
        <NavbarContent className="sm:hidden" justify="center">
          ...
          <NavbarBrand>
            ...
            <Link href="/certs">
              <button color='primary' className='bg-blue-500  text-white py-3 mr-1 px-1 rounded  text-xs'>
                Certificados
              </button>
            </Link>
        ...
        <NavbarContent className="hidden sm:flex gap-4 " justify="end" >
          ...
          <NavbarContent justify="end" >
            <Link href="/login">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 512 512"    >      <g fill='#ffffff'>        <g>          <path d="M360.1 467.2H47.4C20.3 467.2 1 440.8 9.3 415l32.9-102.8c10.6-33 46.7-50.1 78.9-37.6 21.4 8.3 48.9 14.8 82.6 14.8s61.2-6.5 82.6-14.8c1.2-.5 2.5-.9 3.8-1.3v2.5c0 59.1 43.9 108.1 100.8 116.1l7.4 23.1c8.2 25.8-11 52.2-38.2 52.2z"></path>          <circle cx="203.8" cy="147.9" r="103.1"></circle>          <ellipse cx="407.3" cy="275.8" rx="24.1" ry="24.1" transform="rotate(-67.48 407.432 275.65)"          ></ellipse>          <path d="M407.3 178.5c-53.7 0-97.3 43.6-97.3 97.3s43.6 97.3 97.3 97.3 97.3-43.5 97.3-97.3-43.5-97.3-97.3-97.3zm55.4 97.2c0 3.6-.4 7.2-1 10.6l9.1 5.2c4.6 2.7 6.2 8.6 3.5 13.2L466 319c-2.7 4.6-8.6 6.2-13.2 3.5l-9.1-5.2c-5.3 4.7-11.6 8.3-18.4 10.6v10.5c0 5.3-4.3 9.7-9.7 9.7h-16.5c-5.3 0-9.7-4.3-9.7-9.7v-10.5c-6.9-2.4-13.1-6-18.4-10.6l-9.1 5.2c-4.6 2.7-10.5 1.1-13.2-3.5l-8.3-14.3c-2.7-4.6-1.1-10.5 3.5-13.2l9.1-5.2c-.7-3.5-1-7-1-10.6s.4-7.2 1-10.6l-9.1-5.2c-4.6-2.7-6.2-8.6-3.5-13.2l8.3-14.3c2.7-4.6 8.6-6.2 13.2-3.5l9.1 5.2c5.3-4.7 11.6-8.3 18.4-10.6V213c0-5.3 4.3-9.7 9.7-9.7h16.5c5.3 0 9.7 4.3 9.7 9.7v10.5c6.9 2.4 13.1 6 18.4 10.6l9.1-5.2c4.6-2.7 10.5-1.1 13.2 3.5l8.3 14.3c2.7 4.6 1.1 10.5-3.5 13.2l-9.1 5.2c.6 3.4 1 7 1 10.6z"></path>        </g>      </g>    </svg>
            </Link>
            <ThemeSwitcher />
          </NavbarContent>
        </NavbarContent>
