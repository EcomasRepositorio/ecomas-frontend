        ...
        <div className="flex items-center">
          <div className=" flex-1">
            <input
              ...
              placeholder={`Buscar por nombres y apellidos ${searchType === 'name' ? 'nombre' : ''}`}
              required
                  ...
                  {selectedStudentData && (
                    <Modal open={openModals[index]} onClose={() => closeStudentModal(index)}>
                      <div className='flex justify-center items-center mb-4 gap-1'>
                        <Image src={'/certificate/UNP.png'} alt='ecomas' className="md:w-20 w-16  object-contain mt-2" width={200} height={200} priority={true} />
                        <Image src={'/certificate/LOGO-VERTICAL-COLOR.png'} alt='ecomas' className="md:w-20  w-16 h-[125px] md:mt-[13px] mt-[11px] object-contain" width={200} height={200} priority={true} />
                        <Image src={'/certificate/CAL.png'} alt='ecomas' className="md:w-20  w-16 object-contain mt-2" width={200} height={200} priority={true} />
                        <Image src={'/certificate/CIP.png'} alt='ecomas' className="md:w-20  w-16 object-contain mt-2" width={200} height={200} priority={true} />
                      </div>
