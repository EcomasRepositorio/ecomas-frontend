  ...
  return (
    <section id="/diplomados">
      <div className=" p-5 flex flex-col">
        <div
          id="civil"
          className="flex text-primaryblue text-center text-3xl  lg:text-5xl xl:text-5xl lg:w-3/4 mb-4 font-bold font-poppins lg:ml-72"
        >
        ...
        <div
          id="derecho"
          className="ml-15flex text-primaryblue text-center text-3xl  lg:text-5xl xl:text-5xl lg:w-3/4 mb-4 font-bold font-poppins lg:ml-72"
        >
